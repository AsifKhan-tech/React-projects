    ...
    <nav className="fixed top-0 left-0 right-0 h-14 bg-yt-bg flex items-center justify-between px-4 z-50">
      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          <span className="text-xl font-bold tracking-tighter">LatteTube</span>
        </div>
      </div>
      ...
      <div className="flex-grow max-w-[600px] flex items-center gap-4 mx-4">
        ...
        <button className="p-2 bg-[#181818] hover:bg-yt-hover rounded-full transition-colors hidden sm:block">
          <svg viewBox="0 0 24 24" className="w-6 h-6 fill-white">
            <path d="M12 3c-4.97 0-9 4.03-9 9s4.03 9 9 9c.83 0 1.5-.67 1.5-1.5s-.67-1.5-1.5-1.5c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6c0 .66-.54 1.2-1.2 1.2-.33 0-.64-.14-.86-.36-.21-.22-.34-.52-.34-.84 0-1.1-.9-2-2-2s-2 .9-2 2 .9 2 2 2c.32 0 .62-.13.84-.34.22-.22.36-.53.36-.86 0-.66.54-1.2 1.2-1.2s1.2.54 1.2 1.2c0 3.31 2.69 6 6 6s6-2.69 6-6-2.69-6-6-6z"></path>
          </svg>
        </button>
      </div>
      ...
      <div className="flex items-center gap-2">
        <button className="p-2 hover:bg-yt-hover rounded-full transition-colors hidden md:block">
          <svg viewBox="0 0 24 24" className="w-6 h-6 fill-white">
            <path d="M14 13h-3v3H9v-3H6v-2h3V8h2v3h3v2zm3-7H3v12h14v-9h4v11H1v-15h16v3z"></path>
          </svg>
        </button>
        <button className="p-2 hover:bg-yt-hover rounded-full transition-colors hidden md:block">
          <svg viewBox="0 0 24 24" className="w-6 h-6 fill-white">
            <path d="M10 20h4c0 1.1-.9 2-2 2s-2-.9-2-2zm10-2.65V19H4v-1.65l2-1.88v-5.15C6 7.4 7.56 5.1 10 4.34v-.34c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5v.34c2.44.76 4 3.06 4 5.98v5.15l2 1.88z"></path>
          </svg>
        </button>
