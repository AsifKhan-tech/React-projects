...
- **Elegant Data Presentation**: View real-time stats including total available jokes, total pages, and your current page via a sleek floating stats ribbon.
...
- **FreeAPI**: Integration with the `randomjokes` public API endpoint.
